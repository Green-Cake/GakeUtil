...
open class ClosedInt(value: Int, range: IntRange): ClosedNumber<Int>, Serializable {
    ...
    open fun copy(v: Int) = ClosedInt(v, range)

    override fun toString() = value.toString()

    override fun hashCode(): Int {
        var result = value
        result = 31 * result + MIN_VALUE
...
fun ClosedInt.isOverflowable(): Boolean {

    contract {

        returns(true) implies (this@isOverflowable is OverflowableClosedInt)

    }

    return this is OverflowableClosedInt
